...
Message it from iMessage, Telegram, Slack, or Mattermost, give it recurring jobs, and let it
...
<div class="push-steps" markdown="0">
  <div><span>01</span><strong>Message your assistant</strong><p>Use iMessage, Telegram, Slack, or Mattermost from wherever you are.</p></div>
...
-   :material-message-processing-outline:{ .lg .middle } **Connect your chat**
    ...
    [Slack](slack.md), or [Mattermost](mattermost.md) conversations with narrow
    sender allowlists.
